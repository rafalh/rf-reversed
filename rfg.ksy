  ...
  group:
    seq:
      ...
      - id: moving_data
        ...
        if: is_moving != 0
      - id: brushes
        type: brushes_section
      - id: geo_regions
        type: geo_regions_section
      - id: lights
        type: lights_section
      - id: cutscene_cameras
        type: cutscene_cameras_section
      - id: cutscene_path_nodes
        type: cutscene_path_nodes_section
      - id: ambient_sounds
        type: ambient_sounds_section
      - id: events
        type: events_section
      - id: mp_respawn_points
        type: mp_respawn_points_section
      - id: num_nav_points
        type: s4
      - id: nav_points
        type: nav_point
      ...
      - id: entities
        type: entities_section
      - id: items
        type: items_section
      - id: clutters
        type: clutters_section
      - id: triggers
        type: triggers_section
      - id: particle_emitters
        type: particle_emitters_section
      - id: gas_regions
        type: gas_regions_section
      - id: decals
        type: decals_section
      - id: climbing_regions
        type: climbing_regions_section
      - id: room_effects
        type: room_effects_section
      - id: eax_effects
        type: eax_effects_section
      - id: bolt_emitters
        type: bolt_emitter_section
      - id: targets
        type: targets_section
      - id: push_regions
        type: push_regions_section
  vstring:
